...
class Tracker(db.Model):
    ...
    settings = db.relationship('Settings', backref='tracker', cascade="all,delete", lazy="subquery")
    ttype = db.relationship('Tracker_type', backref='tracker', cascade="all,delete", lazy="subquery")
    values = db.relationship('Tracker_log', backref='tracker', cascade="all,delete", lazy="subquery")
...
class Tracker_log(db.Model):
    ...
    values = db.relationship('Tracker_log_value', backref='tracker_logs', cascade="all,delete", lazy="subquery")
